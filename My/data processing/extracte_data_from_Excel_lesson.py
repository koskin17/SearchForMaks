...
"""Метод parse, который прописан в строке 9, можно вызвать сразу в методе чтения файла.
...
print(data["Date"])
"""После преобразования данных DOM time и ДLoad time в целочисленный тип уже можно их обрабатывать.
