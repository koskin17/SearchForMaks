...
#   # Класс, описывающий GUI-приложение
class TextSearchApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Поиск по тексту в файлах")  # Заголовок главного окна
        ...
        self.search_entry.grid(row=0, column=1, padx=5, pady=5, sticky=tk.W)  # Размещение поля
        ...
        self.add_context_menu(self.search_entry)  # Добавляем контекстное меню ПКМ
